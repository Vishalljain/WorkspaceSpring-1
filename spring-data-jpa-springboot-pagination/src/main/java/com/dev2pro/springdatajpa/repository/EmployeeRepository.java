...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    Employee findTopByDesignationOrderBySalaryDesc(String designation);//it will give highest salary for that designation
    
    
    
    //findTopBy  DesignationOrderBy SalaryDesc
